...
waterChem_long%>%
  ggplot(aes(x=date_time,y=concen_uM,color=Site))+
...
ggsave("Z:/Brianna/Projects/2022_0328_CINAR_BC/BC_CoralSeagrass_Temporal/USVI_2021_CINAR_temporal_R_Script/figures/Temporally_Significant_TargetedMetabolites_log10_concentration_20250128.png",plot = last_plot(),height=8.5,width=8,units = "in",dpi=600)
...
fig_s2 <- temporal_long_wLimits_outliersRmv %>%
  ungroup()%>%
...
#ggsave("Z:/Brianna/Projects/2022_0328_CINAR_BC/BC_CoralSeagrass_Temporal/USVI_2021_CINAR_temporal_R_Script/figures/FigureS1_Mtab_Heatmap_medianConcentration_nM_v2_20250122.pdf",plot = fig_s2,height = 11,width = 8.5,dpi = 300)
